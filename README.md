...
Run `make help` for the full target list. See
 [`docs/developer/GUIDE.md`](docs/developer/GUIDE.md) for the full developer
guide (setup, workflow, debugging).
...
Full list: [`docs/developer/GUIDE.md`](docs/developer/GUIDE.md#common-fixes).

## Documentation

- [`docs/developer/GUIDE.md`](docs/developer/GUIDE.md) — setup, daily workflow, testing, debugging, common fixes.
...
- [`docs/CLOUD.md`](docs/CLOUD.md) — running the full pipeline on cloud infrastructure.
- [`docs/loadtest.md`](docs/loadtest.md) — load testing and capacity planning.
...
| [`.ai/AI-CONTEXT.md`](.ai/AI-CONTEXT.md) | Drop into any agent's context for token-optimized full repo summary (generated by ai-enrich). |
